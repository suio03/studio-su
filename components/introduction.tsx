        ...
        <div className='flex flex-col items-center justify-center font-bellota p-4'>
            <div className="bg-white/50 p-4 sm:p-6 rounded-lg shadow-lg w-full max-w-xl flex items-center relative">
                ...
                <div className='px-3 sm:px-6 py-4 sm:py-6'>
                    <h2 className="text-2xl sm:text-3xl font-bold text-white text-center sm:text-right font-nerko mb-4">Hi Hi Hi, I&apos;m Suyun !</h2>
                    <p className="text-gray-700">A curious and solution-focused UI/UX design student at <span className='underline font-bold'>Curtin University</span>.</p>
                    <p className="text-gray-700">I enjoy turning <span className='font-bold underline'>user needs into intuitive interfaces</span> – whether I&apos;m sketching wireframes solo or collaborating in a creative team. Right now, I&apos;m diving deeper into <span className='font-bold underline'>front-end development</span> to bring my designs to life through real projects.</p>
                </div>
            </div>
            ...
            <div className="bg-white/50 p-4 sm:p-6 rounded-lg shadow-lg w-full max-w-xl mt-16 sm:mt-24 flex items-center relative">
                <div className='px-3 sm:px-6 py-4 sm:py-6'>
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-white font-nerko mb-4">Fresh from the Studio</h2>
                    <p className="text-gray-700">A selection of my latest <span className='font-bold underline'>UX case studies, prototypes, and design concepts.</span> Each one shows how I solve problems with clarity, empathy, and a dash of personality.</p>
