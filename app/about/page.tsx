...
const About = () => {
    return (
        <div className="pt-24 sm:pt-36 bg-[#B492C0] min-h-screen px-4">
            <div className="max-w-3xl mx-auto relative">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center mb-8 sm:mb-0">
                    <Image src={Introduction03} alt="Introduction03" className="w-32 sm:w-auto" />
                    <p className="text-5xl sm:text-8xl font-nerko text-[#CFD772] mt-4 sm:mt-0">
                        Hey! U~
                    </p>
                </div>
                <div className="flex justify-center items-center my-8 sm:my-12">
                    <p className="text-base sm:text-xl font-bellota text-center sm:text-left">
